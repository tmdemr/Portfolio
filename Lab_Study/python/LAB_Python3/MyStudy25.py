...
"""
이 방법은 간단한 계층 구조에서는 잘 돌아가지만. 하지만 바람직하지 않다.
클래스가 다중 상속을 받는다면 슈퍼클래스의 __init__ 메소드를 직접 호출하는 행위는
예기치 못한 동작을 일으킬 수 있다.
문제는 __init__의 호출 순서가 모든 서브 클래스에 걸쳐 명시되어 있지 않다는 점.
"""
...
"""
원래 값 5에 2를 곱하고 5를 더하니 15가 나올 것 같다.
"""
...
class Explicit(MyBaseClass): #명백한
    def __init__(self, value):
        super(__class__, self).__init__(value * 2)


class Implicit(MyBaseClass): #절대적인. super의 인자 없이 간결하게 사용 가능.
    def __init__(self, value):
